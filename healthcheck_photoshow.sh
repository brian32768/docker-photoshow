...
/usr/bin/curl -L --fail -s https://giscache.co.clatsop.or.us/photoshow/ > /dev/null || echo `hostname` photoshow webserver not running https://giscache.co.clatsop.or.us/photoshow || exit 1
